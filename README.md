Тестовое задание компании Fabrique.studio
======

Данный репозиторий создан для выполнения тестового задания компании Fabrique.studio на вакансию Python Developer.
